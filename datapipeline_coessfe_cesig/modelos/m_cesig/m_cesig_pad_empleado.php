...
class m_cesig_pad_empleado {
    ...
    // Constructor
    public function __construct($id, $versionnumber, $creationtimestamp, $creationuser, $modificationuser, $deleted, $numerocuenta, $nombretitular, $cuittitular, $idtipopersona) {
        $this->id = $id;
